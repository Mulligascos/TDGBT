...
export default function App() {
  ...
  const renderPage = () => {
    switch (activeTab) {
      ...
      case "history":
        return (
          <HistoryPage {...commonProps} matches={matches} players={players} />
        );
      case "courses":
        return <CoursesPage {...commonProps} courses={courses} />;
      case "admin":
        return (
          <AdminPanel
      ...
      case "bagtags":
        return <BagTagsPage currentUser={currentUser} players={players} />;
      case "lostfound":
        return (
          <LostFoundPage
            currentUser={currentUser}
